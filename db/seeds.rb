beers = [
    { title: "Hoegaarden", description: "Tastes good", price: "11.99", opened: Date.current - 4.hours },
    ...
    { title: "1664", description: "Tastes good", price: "8.99", opened: Date.current - 8.hours },
    ...
    { title: "IPA Tripel", description: "Tastes good", price: "9.99", opened: Date.current - 11.hours },
    { title: "Oktoberfest", description: "Tastes good", price: "7.99", opened: Date.current - 12.hours },
    ...
    { title: "Erdinger Hefe Weizen", description: "Tastes good", price: "3.99", opened: Date.current - 23.hours }
]
